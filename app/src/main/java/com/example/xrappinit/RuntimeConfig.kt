...
/**
 * Runtime configuration overlay for rayclaw.
 *
 * Reads `rayclaw.conf` from the app's external-files directory at startup,
 ...
 *       rayclaw.conf.template  →  rayclaw.conf
 *
 ...
 *       adb push rayclaw.conf /sdcard/Android/data/com.example.xrappinit/files/rayclaw.conf
 *
...
object RuntimeConfig {
    ...
    private const val CONFIG_FILE = "rayclaw.conf"
    ...
    /** True if rayclaw.conf was found and loaded successfully. */
